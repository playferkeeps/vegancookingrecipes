...
// Original recipes preserved below for reference during migration
import { Recipe, RecipeCategory, VeganType } from '@/types/recipe';

// Export original recipes for use in modular structure
export const originalRecipes: Recipe[] = [
  {
    ...
    instructions: [
      ...
      {
        step: 3,
        text: 'In a large bowl, cream together vegan butter and both sugars until light and fluffy.',
      },
      {
        step: 4,
        text: 'Add vanilla extract and plant-based milk, mix until combined.',
      },
      {
        step: 5,
      ...
      {
        step: 8,
        text: 'Bake for 10-12 minutes or until edges are golden brown. Let cool on baking sheet for 5 minutes before transferring to wire rack.',
      },
    ],
    nutritionInfo: {
      calories: 120,
    ...
    faqs: [
      {
        question: 'Do I need to chill the cookie dough?',
        answer: 'No, this vegan chocolate chip cookie recipe doesn\'t require chilling. The dough can be baked immediately after mixing. However, if you prefer thicker cookies, you can chill the dough for 30 minutes to 1 hour before baking.',
      },
      {
        question: 'Why are my cookies spreading too much?',
        answer: 'If your cookies are spreading too much, the vegan butter might be too soft or melted. Make sure it\'s softened but still cool to the touch. You can also add 1-2 tablespoons more flour to the dough. Over-mixing can also cause spreading, so mix just until combined.',
      },
      {
        question: 'Can I make these cookies gluten-free?',
        answer: 'Yes! Substitute the all-purpose flour with a 1:1 gluten-free flour blend. I recommend Bob\'s Red Mill, King Arthur, or Better Batter gluten-free flour. The cookies will have a slightly different texture but will still be delicious.',
      },
      {
        question: 'How long do these vegan cookies stay fresh?',
        answer: 'These cookies will stay fresh for 3-4 days when stored in an airtight container at room temperature. They also freeze beautifully - either freeze the baked cookies or freeze the cookie dough balls for fresh-baked cookies anytime.',
      },
      {
        question: 'Can I use coconut oil instead of vegan butter?',
        answer: 'Yes, but it will change the texture and flavor. Coconut oil tends to make cookies crispier and adds a slight coconut flavor. For best results, use solid coconut oil (not melted) and expect a different texture than with vegan butter.',
      },
      {
        question: 'Are all chocolate chips vegan?',
        answer: 'No, many chocolate chips contain dairy products like milk fat or butter oil. Always check the ingredients list. Enjoy Life brand is always vegan, as are Trader Joe\'s semi-sweet chips and many store brands. When in doubt, check for dairy ingredients on the label.',
      },
    ],
    tips: [
    ...
    relatedRecipeIds: ['3', '7'], // Banana bread and lasagna
  },
  {
    id: '2',
    ...
    instructions: [
      {
        step: 1,
        text: 'Cook rice noodles according to package directions. Drain and set aside.',
      },
      {
        step: 2,
        text: 'In a small bowl, mix together lime juice, tamarind paste, soy sauce, and brown sugar to make the sauce.',
      },
      {
        step: 3,
        text: 'Heat oil in a large wok or skillet over medium-high heat. Add tofu and cook until golden brown on all sides, about 5-7 minutes.',
      },
      {
        step: 4,
      ...
      {
        step: 5,
        text: 'Add carrots and bean sprouts, stir-fry for 2-3 minutes.',
      },
      {
        step: 6,
        text: 'Add cooked noodles and sauce. Toss everything together and cook for 2-3 minutes until well combined.',
      },
      {
        step: 7,
        text: 'Garnish with green onions, crushed peanuts, and cilantro. Serve immediately with lime wedges.',
      },
    ],
    nutritionInfo: {
      calories: 380,
    ...
    faqs: [
      {
        question: 'Can I make this Pad Thai without tamarind paste?',
        answer: 'While tamarind paste gives authentic Pad Thai its signature tangy flavor, you can substitute it with 2 tablespoons of lime juice mixed with 1 tablespoon of brown sugar. The flavor will be slightly different but still delicious.',
      },
      {
        question: 'How do I prevent the noodles from sticking together?',
        answer: 'Make sure to cook the rice noodles according to package directions and rinse them with cold water after cooking. Have all your ingredients prepped and ready before you start cooking, as Pad Thai comes together quickly.',
      },
      {
        question: 'Can I make this recipe gluten-free?',
        answer: 'Yes! Use tamari instead of soy sauce, and make sure your rice noodles are gluten-free (most are naturally gluten-free). Check all sauce labels to ensure they\'re gluten-free.',
      },
      {
        question: 'What can I substitute for tofu?',
        answer: 'You can use tempeh, seitan, or simply add more vegetables like bell peppers, snap peas, or mushrooms. The recipe is very flexible with protein options.',
      },
      {
        question: 'How do I store leftover Pad Thai?',
        answer: 'Store leftovers in an airtight container in the refrigerator for up to 3 days. Reheat in a wok or large pan with a splash of water or vegetable broth to prevent sticking.',
      },
    ],
    tips: [
    ...
    relatedRecipeIds: ['4', '8'], // Chickpea curry and sushi
  },
  {
    id: '3',
    ...
    instructions: [
      ...
      {
        step: 2,
        text: 'In a large bowl, mash the bananas until smooth.',
      },
      {
        step: 3,
        text: 'Add coconut oil, maple syrup, plant-based milk, and vanilla extract. Mix well.',
      },
      {
        step: 4,
      ...
      {
        step: 5,
        text: 'Gradually add dry ingredients to wet ingredients, mixing until just combined. Do not overmix.',
      },
      {
        step: 6,
        text: 'Fold in walnuts if using.',
      },
      {
        step: 7,
        text: 'Pour batter into prepared loaf pan and smooth the top.',
      },
      {
        step: 8,
        text: 'Bake for 55-60 minutes, or until a toothpick inserted into the center comes out clean.',
      },
      {
        step: 9,
        text: 'Let cool in pan for 10 minutes, then transfer to wire rack to cool completely.',
      },
    ],
    nutritionInfo: {
      calories: 180,
  ...
  },
  {
    ...
    instructions: [
      {
        step: 1,
        text: 'Heat oil in a large pot over medium heat. Add onion and cook until translucent, about 5 minutes.',
      },
      {
        step: 2,
        text: 'Add garlic and ginger, cook for 1 minute until fragrant.',
      },
      {
        step: 3,
        text: 'Add all spices (curry powder, turmeric, cumin, coriander, cayenne) and stir for 30 seconds.',
      },
      {
        step: 4,
        text: 'Add tomatoes and cook until they start to break down, about 5 minutes.',
      },
      {
        step: 5,
        text: 'Add chickpeas and coconut milk. Bring to a simmer.',
      },
      {
        step: 6,
        text: 'Reduce heat to low, cover, and simmer for 15-20 minutes, stirring occasionally.',
      },
      {
        step: 7,
        text: 'Season with salt to taste. Garnish with fresh cilantro before serving.',
      },
      {
        step: 8,
        text: 'Serve over basmati rice or with naan bread.',
      },
    ],
    nutritionInfo: {
      calories: 320,
  ...
  },
  {
    ...
    instructions: [
      ...
      {
        step: 2,
        text: 'While bread is toasting, mash avocados in a bowl with lemon juice, salt, and pepper.',
      },
      {
        step: 3,
      ...
      {
        step: 4,
        text: 'Top with cherry tomatoes, microgreens, and a sprinkle of red pepper flakes if desired.',
      },
      {
        step: 5,
  ...
  },
  {
    ...
    instructions: [
      {
        step: 1,
        text: 'Add frozen banana, spinach, mango, and plant-based milk to a blender.',
      },
      {
        step: 2,
        text: 'Blend until smooth and creamy, adding more milk if needed to reach desired consistency.',
      },
      {
        step: 3,
        text: 'Pour into a bowl and top with chia seeds, berries, granola, and coconut flakes.',
      },
      {
        step: 4,
        text: 'Serve immediately.',
  ...
  },
  {
    ...
    instructions: [
      {
        step: 1,
        text: 'Preheat oven to 375°F (190°C). Cook lasagna noodles according to package directions. Drain and set aside.',
      },
      {
        step: 2,
        text: 'Make cashew ricotta: Blend soaked cashews, nutritional yeast, lemon juice, garlic, and 1/2 cup water until smooth. Season with salt.',
      },
      {
        step: 3,
        text: 'Heat olive oil in a pan. Sauté mushrooms and zucchini until tender, about 5-7 minutes. Add spinach and cook until wilted.',
      },
      {
        step: 4,
        text: 'In a 9x13 inch baking dish, spread a thin layer of marinara sauce.',
      },
      {
        step: 5,
        text: 'Layer: 4 noodles, 1/3 cashew ricotta, 1/3 vegetables, 1/3 marinara sauce. Repeat twice.',
      },
      {
        step: 6,
        text: 'Top with remaining noodles, sauce, and vegan mozzarella.',
      },
      {
        step: 7,
        text: 'Cover with foil and bake for 30 minutes. Remove foil and bake for 15 more minutes until bubbly.',
      },
      {
        step: 8,
  ...
  },
  {
    ...
    instructions: [
      {
        step: 1,
        text: 'Cook sushi rice according to package directions. Let cool slightly.',
      },
      {
        step: 2,
        text: 'Mix rice vinegar, sugar, and salt. Gently fold into warm rice.',
      },
      {
        step: 3,
        text: 'Place a nori sheet on a bamboo sushi mat, shiny side down.',
      },
      {
        step: 4,
        text: 'Spread 1/2 cup rice evenly over nori, leaving 1 inch at the top edge.',
      },
      {
        step: 5,
        text: 'Arrange avocado, cucumber, carrots, and pickled radish in a line across the bottom third of the rice.',
      },
      {
        step: 6,
        text: 'Roll tightly using the mat, pressing gently. Moisten the top edge with water to seal.',
      },
      {
        step: 7,
        text: 'Repeat with remaining nori sheets and fillings.',
      },
      {
        step: 8,
        text: 'Slice each roll into 8 pieces with a sharp, wet knife. Serve with soy sauce, wasabi, and pickled ginger.',
      },
    ],
    nutritionInfo: {
      calories: 280,
...
// Helper functions are now exported from ./recipes/index
// These are kept here for reference but not exported to avoid conflicts
